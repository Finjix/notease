...
$command = "`"$vcvars`" x64 && cl /nologo /utf-8 /std:c++17 /EHsc /W4 /permissive- /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DNOMINMAX /D_WIN32_WINNT=0x0A00 /Fo:`"$objectFile`" /Fe:`"$output`" `"$source`" /link /SUBSYSTEM:WINDOWS advapi32.lib gdi32.lib shell32.lib user32.lib"
